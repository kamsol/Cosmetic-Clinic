...
<div id="wowslider-container1" style="" >     
    ...
    <div class="ws_images" >
        <ul>
            ...
            <li><img src="data1/images/slide3.jpg" alt="slide2" title="slide2" id="wows1_6"/></li>
...
<a href="http://clinique-linstant.no/tilbud/" id="tilbud" >Nåværende Tilbud <i style="font-size:26px;margin-left:5px" class="fa fa-hand-pointer-o " ></i></a>


<div class="container hejmInfo">

    <p class="info">Clinique Linstant tilbyr forskjellige behandlinger innen hud og kosmetikk med ulike metoder. Se "tjeneste meny" øverst på siden for å se behandlinger og priser.</p>
    ...
    <p class="info">Shine like a diamond with <br><strong style="font-size:25px;display:inline-block;color:red">C</strong>linique <b style="font-size:25px;color:red">L</b>instant</p>
