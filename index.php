...
>>>>>>> origin/master
        ...
        <div class="col-lg-4 col-sm-4 ">
                ...
                <p class="animated wow fadeInUp">Vi er spesialisert på ansiktsbehandlinger. Hos oss får du skreddersydd behandlinger tilpasset din hud og dine behov.</p>
        </div>
...
>>>>>>> origin/master
    ...
    <div class="col-lg-4 col-sm-4 ">
                <img class="img-responsive img-circle animated wow fadeInUp"  src="http://clinique-linstant.no/image/makeup-pink.jpg" alt="makeup bildet" />
                <h2>Makeup</h2>
                <p class="animated wow fadeInUp">Vår eksklusive make up består av ulike pleiende ingredienser. Opplev en mystisk, romantisk eller sofistikert look.</p>
        </div>
...
<div class="container hejmInfo">
    ...
    <p class="info">Clinique Linstant tilbyr forskjellige behandlinger innen hud og kosmetikk med ulike metoder</p>
